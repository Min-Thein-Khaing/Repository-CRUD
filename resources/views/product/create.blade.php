        ...
        <form action={{ route('product.store') }} method="POST">
            ...
            <div class="grid   gap-2 bg-white ">
                <div class="mb-2">
                    ...
                    <input type="text" class="rounded-lg w-full" value="{{ old('name') }}" name="name" id="name">
                    @error('name')
                ...
                <div class="mb-2">
                    ...
                    <input type="number" class="rounded-lg w-full" value="{{ old('price') }}" name="price" id="price">
                    @error('price')
                    <p class="text-red-500">{{ $message }}</p>
                ...
                <div class="  mb-2   ">
                    ...
                    <input type="number" class="rounded-lg w-full" value="{{ old('stock') }}" name="stock" id="stock">
                    @error('stock')
                    <p class="text-red-500">{{ $message }}</p>
                ...
                <div class="  mb-2  ">
                    ...
                    <textarea type="text" class="rounded-lg w-full" name="description" id="description">{{old('description')}}</textarea>
                    @error('description')
                    <p class="text-red-500">{{ $message }}</p>
